    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border 
          border-gray-200 bg-white px-7 py-2 shadow-md backkdrop-blur transition-all hover:border-gray-300 hover: bg-white/50">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Quill allows you to have conversations with any PDF doccument. Simply upload your file and start asking questions right away.
        </p>
        ...
        <div className="relative isolate">
          <div 
            ...
            transform-gpu overflow-hidden blur-3xl sm:-top-80">
              <div 
                style={{
                  clipPath: "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, \
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 
              pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                ...
                <span className="mt-2 text-zinc-700">
                  Either statring out with a free plan or chooose our {" "}
                  <Link href='/pricing' 
                    className="text-purple-700 underline underline-offset-2">pro plan</Link>.
                </span>
            </div>
          </li>
          <li className="md:flex-1">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 
              pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                ...
                <span className="text-xl font-semibold">Starting asking questions</span>
                <span className="mt-2 text-zinc-700">
                  It's really that simple. Try out Quill today ~ it really takes less than a minute.
                </span>
            </div>
          </li>
        </ol>
